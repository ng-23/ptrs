...
from ptrs.app import API_FILTERS, API_SORT_BY_PARAM, API_SORT_OPERATORS
...
def distill_query_params(req: Request):
    ...
    A tpyical URL query string is of the format site.com/endpoint/?foo=10. Here, the query operates on objects with field foo equal to 10.
